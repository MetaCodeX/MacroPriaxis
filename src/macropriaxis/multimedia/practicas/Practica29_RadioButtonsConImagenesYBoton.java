...
public class Practica29_RadioButtonsConImagenesYBoton {
    
    public static void ejecutar() {
        try {
            Stage stage = new Stage();
            stage.setTitle("Práctica 29 - RadioButtons con Imágenes y Botón - Carlos Eduardo Juarez Ricardo - 09/09/2025");
            ...
            Label instructionLabel = new Label("Selecciona una opción con imagen y presiona Enviar");
            instructionLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: blue;");
            
            // Crear grupo de botones de radio
            ToggleGroup group = new ToggleGroup();
            
            // Crear imágenes para los botones de radio
            Image imagen1 = new Image("file:src/macropriaxis/media/Cube.png", true);
            ImageView imageView1 = new ImageView(imagen1);
            imageView1.setFitWidth(100);
            imageView1.setFitHeight(100);
            imageView1.setPreserveRatio(true);
            
            Image imagen2 = new Image("file:src/macropriaxis/media/Triangle.png", true);
            ImageView imageView2 = new ImageView(imagen2);
            imageView2.setFitWidth(100);
            imageView2.setFitHeight(100);
            imageView2.setPreserveRatio(true);
            
            // Crear botones de radio con imágenes
            RadioButton rb1 = new RadioButton("Opción 1");
            rb1.setGraphic(imageView1);
            ...
            stage.setOnCloseRequest(e -> {
                try {
                    System.out.println("Práctica 29 cerrada correctamente");
                    // Limpiar referencias
                    boton.setOnAction(null);
                    mainContainer.getChildren().clear();
                    controlsContainer.getChildren().clear();
                } catch (Exception ex) {
                    System.err.println("Error al cerrar práctica 29: " + ex.getMessage());
                }
            });
            ...
            System.err.println("Error crítico en Práctica 29: " + e.getMessage());
            e.printStackTrace();
            throw new RuntimeException("Error al ejecutar Práctica 29", e);
        }
    }
}
