...
public class serpent extends JFrame {
    ...
    private class PanelSerpiente extends JPanel implements ActionListener, KeyListener {
        ...
        private void iniciarJuego() {
            serpienteX.clear();
            serpienteY.clear();
            longitudSerpiente = 5; // Longitud inicial más corta y realista
            direccion = 'D';
            puntaje = 0;
    ...
    // El método main puede permanecer pero no es necesario cuando se llama desde IndexGigas
